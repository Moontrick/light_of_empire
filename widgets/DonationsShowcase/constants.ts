...
export const SHOWCASE_STEPS: DonationStep[] = [
  {
    index: '01',
    title: 'Выбери товар',
    text: 'Скины, личные профессии и именные персонажи — все за кредиты Империи.',
  },
  {
    index: '02',
    title: 'Оставь заявку',
    text: 'Укажи Steam — кредиты спишутся, а заявка уйдет администрации на выдачу.',
  },
  {
    index: '03',
    title: 'Получи в игре',
    text: 'Администрация подтверждает выдачу, статус заявки виден в личном кабинете.',
  },
];
